...
public class Message {
     ...
     * @return
     */
    public static String getFileReceiveMessage(String fileName,int filesize,String to)
    {
        return Constants.RECEIVE+":"+fileName+":"+filesize+":"+to;
    }
    /**
     ...
     * @return
     */
    public static String getExistingUserNotifyMessage(String ID)
    {
        return Constants.EXISTING_USER+":"+ID;
    }
    /**
     * Returns user removed notification.
     * @param ID
     * @return
     */
    public static String getUserRemovedNotificationMessage(String ID)
    {
        return Constants.USER_REMOVED+":"+ID;
    }
}
